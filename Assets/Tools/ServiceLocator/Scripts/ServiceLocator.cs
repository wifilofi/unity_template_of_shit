...
namespace ServiceLocator.Scripts
{
    ...
    public class ServiceLocator : MonoBehaviour
    {
        ...
        public static ServiceLocator ForSceneOfCurrent()
        {
        ...
        {
            Debug.Log(services.RegisteredServices.Count());
            sceneContainers.Remove(SceneManager.GetActiveScene());
            Debug.Log(sceneContainers.ContainsKey(SceneManager.GetActiveScene()));
        }
